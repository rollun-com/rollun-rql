define(['dojo/_base/declare', "./util/contains"], function (declare, contains) {
    return declare('RqlParser', {}, {
        operatorMap: {
            "=": "eq",
            "==": "eq",
            ">": "gt",
        ...
        primaryKeyName: 'id',
        lastSeen: ['sort', 'select', 'values', 'limit'],
        ...
        converters: {
            ...
            glob: function (x) {
                var s = decodeURIComponent(x).replace(/([\\|\||\(|\)|\[|\{|\^|\$|\*|\+|\?|\.|\<|\>])/g, function (x) {
                    return '\\' + x;
                }).replace(/\\\*/g, '.*').replace(/\\\?/g, '.?');
        ...
        constructor: function () {
            // converters["default"] can be changed to a different converter if you want
         ...
         */
        parse: function (query, parameters) { //TODO: rewrite to work with dedicated node object
        ...
        /** alias that is needed to maintain backwards compatability */
        parseQuery: function (query, parameters) {
            return this.parse(query, parameters);
        },
